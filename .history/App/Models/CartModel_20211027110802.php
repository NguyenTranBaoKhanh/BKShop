...
class CartModel extends Database
{
    ...
    function donhang($data)
    {
        if (isset($data)) {
            ...
            $sql->bind_param("ississs", $id, $ngaydat, $ngaygiao, $gia, $trangthai, $diachi, $sdt);
            $sql->execute();
            $result = $sql->get_result();
    ...
    function chitietdonhang($id_donhang, $ten_hang_hoa, $so_luong, $gia)
    {
        $sql = $this->conn->prepare("insert into chitietdonhang(id_donhang, ten_hang_hoa, so_luong, gia) values(?, ?, ?, ?)");
        $sql->bind_param("isii", $id_donhang, $ten_hang_hoa, $so_luong, $gia);
        $sql->execute();

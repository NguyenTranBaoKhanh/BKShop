...
class CartModel extends Database
{
    ...
    function pay($data)
    {
        if (isset($data)) {
            ...
            $sql = $this->conn->prepare("insert into donhang(id_khachhang, ngaydat, ngaygiao, gia, trangthai, diachi) value(?, ?, ?, ?, ?, ?)");
            $sql->bind_param("ississ", $id, $ngaydat, $ngaygiao,$gia , $diachi, $sdt);
            $sql->execute();
        }
    }

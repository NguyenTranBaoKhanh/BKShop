...
class CartModel extends Database
{
    ...
    {
        $sql = $this->conn->prepare("select * from hanghoa join giohang on hanghoa.id=giohang.id_hanghoa join khachhang on giohang id_khachhang=khachhang.id where khachhang.id=?");
        $sql->bind_param("i", $id_khachhang);
        $sql->execute();
        $result = $sql->get_result();
    ...
    //xóa cake khỏi card
    function deleteCart($id_khachhang, $id_hanghoa)
    {

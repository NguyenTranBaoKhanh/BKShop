...
class HomeModel extends Database
{
    ...
    function getAllComment(){
        $sql = $this->conn->prepare("SELECT * from binhluan JOIN khachhang ON binhluan.id_khachhang = khachhang.id ORDER BY binhluan.id DESC");
        // $sql->bind_param("i", $id);
        $sql->execute();
    ...
    function addComment($iditem, $iduser, $cmt, $rate)
    {
        ...
        $sql->bind_param("iisi", $id_item, $id_user, $comment, $r);
        $sql->execute();

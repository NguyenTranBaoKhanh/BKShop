...
class CartModel extends Database
{
    ...
    {
        $sql = $this->conn->prepare("select * from hanghoa join giohang on hanghoa.id=giohang.id_hanghoa
        join khachhang on giohang.id_khachhang=khachhang.id
        where khachhang.id=2");
        $sql->execute();
        $result = $sql->get_result();

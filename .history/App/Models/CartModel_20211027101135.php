...
class CartModel extends Database
{
    ...
    function donhang($data)
    {
        if (isset($data)) {
            ...
            $sql = $this->conn->prepare("insert into donhang(id_khachhang, ngaydat, ngaygiao, gia, trangthai, diachi, sdt) values(?, ?, ?, ?, ?, ?, ?)");
    ...
    function chitietdonhang($id_khachhang){
        $sql = $this->conn->prepare("select max(id) from donhang where id_khachhang=?");
        $sql->bind_param("i", $id_khachhang);
        $sql->execute();

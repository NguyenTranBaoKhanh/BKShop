            ...
            <?php foreach ($data['item'] as $index => $item) : ?>
              <tr class="">
                ...
                <td class="text-center">
                  <input onchange="changeAmount(), update(<?= $_SESSION['user']['id'] ?>,<?= $item['id'] ?>,amount<?= $index ?>), refreshNumInCart(-1)" max=50 min=0 id="amount<?= $index ?>" class="cart-amount" type="number" value="<?= $item['soluong'] ?>">
                </td>

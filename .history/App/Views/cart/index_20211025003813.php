      ...
      <table class="table border border-success align-middle">
        ...
        <tbody class="">
          ...
          <?php foreach ($data['item'] as $index => $item) : ?>
            <tr class="">
              ...
              <td class="text-center">
                <input onchange="changeAmount()" id="amount<?= $index ?>" class="cart-amount" type="number" value="<?= $item['soluong'] ?>">
              </td>
          ...
          <tr>
            ...
            <td class="text-center"><span id="total" class="total-price"></span><?=number_format($total)?>đ</td>
  ...
  <script>
    function changeAmount() {
      ...
      if (total != undefined) {
        ...
        total.innerHTML = new Intl.NumberFormat().format(totalNumber) + "đ";
      }
      return;
    }
  </script>

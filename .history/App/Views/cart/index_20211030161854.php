            ...
            <?php foreach ($data['item'] as $index => $item) : ?>
              <tr class="list_cart">
                ...
                <td class="text-center">
                  ...
                  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete<?= $index ?>">Xóa</button>

                  <!-- modal -->
                  <div class="modal" id="modal-delete<?= $index ?>" aria-labelledby="my_modalLabel">

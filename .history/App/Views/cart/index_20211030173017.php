                  ...
                  <div class="modal fade" id="exampleModal<?= $index ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        Bạn muốn xóa <?=$item['ten']?>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đong</button>
                          <button type="button" class="btn btn-primary" onclick="deleteItem(<?= $_SESSION['user']['id'] ?>,<?= $item['id'] ?>)">Xóa</button>
                        </div>
                      </div>
                    </div>
                  </div>

                ...
                <?php foreach ($data['sanpham'] as $index => $item) : ?>
                  <tr>
                    ...
                    <td class="d-flex justify-content-around align-items-center">
                      ...
                      <a href="<?= DOCUMENT_ROOT ?>/admin/sanpham/edit/<?= $item['id'] ?>" class="btn btn-primary">Sửa</a>
                      <a href="<?= DOCUMENT_ROOT ?>/admin/sanpham/delete/<?= $item['id'] ?>" class="btn btn-primary">Xóa</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>

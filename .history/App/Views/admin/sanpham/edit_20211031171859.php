      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="masanpham" name="masanpham" <?= $data['item']['ma_sp']?> required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dungluong" name="dungluong" <?= $data['item']['dung_luong']?> required>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="mau">Màu:</label>
            <input type="text" class="form-control" id="mau" name="mau" <?= $data['item']['mau']?> required>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="gia" name="gia" <?= $data['item']['gia']?> required>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label for="soluong">Số lượng:</label>
            <input type="text" class="form-control" id="soluong" name="soluong" <?= $data['item']['so_luong']?> required>
          </div>
        </div>
      </div>
      <div class="form-group">

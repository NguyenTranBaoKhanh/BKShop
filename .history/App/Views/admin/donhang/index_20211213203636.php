              ...
              <tbody>
                <?php foreach ($data['donhang'] as $index => $donhang) : ?>
                  <tr>
                    ...
                    <td><div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" value="<?= $donhang['ngay_giao'] ?>" class="form-control datetimepicker-input" data-target="#reservationdate"/>

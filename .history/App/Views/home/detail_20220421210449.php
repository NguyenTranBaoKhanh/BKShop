        ...
        <div class="container ">
            ...
            <div class="product__name d-flex justify-content-between">
                ...
                <div class="product__rating">
                    <span class="point">
                        <span class="point-left">3.5</span><span class="point-right">/5</span></span>
                    ...
                    <div class="cmt-top-left">
                        <div class="panel">
                            <div class="panel-body">
                                <input type="text" class=" cmt-input" style="font-size: 2rem"
                        ...
                        <div class="card p-3 mt-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="user d-flex flex-row align-items-center">
                                    ...
                                    <span>
                                        <small class="font-weight-bold text-primary">james_olesenn</small>
                                        <small class="font-weight-bold cmt-content">Hmm, hay quá anh hay quá anh hay quá
                                            anh hay quá anh hay quá anh hay quá anh hay quá anh hay quá anh hay quá anh
                                            hay quá anh hay quá anh hay quá anh hay quá anh hay quá anh hay quá anh hay
                                            quá anh hay quá anh hay quá hay quá anh hay quá anh hay quá anh hay quá anh
                                            anh hay quá anh hay quá anh hay quá anh</small>
                                    </span>
                                </div>
                                <small>2 days ago</small>
                            </div>
                        ...
                        <div class="card p-3 mt-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="user d-flex flex-row align-items-center">
                                    ...
                                    <span>
                                        <small class="font-weight-bold text-primary">james_olesenn</small>
                                        <small class="font-weight-bold">Hmm, tuyệt ời</small>
                                    </span>
                                </div>
                                <small>2 days ago</small>
                            </div>

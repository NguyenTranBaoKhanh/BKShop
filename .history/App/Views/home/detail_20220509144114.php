    ...
    <div class="wrapper">
        ...
        <div class="container mb-5">
            <form action="<?=DOCUMENT_ROOT?>/home/comment/<?=$item['id_url']. "/" . $item['mau_url'] ?>" method="post">
                <div class="cmt-top">
                    ...
                    <div class="cmt-top-right cmt-top-right--separate">
                        ...
                        <div class="star-widget">
                            <input type="radio" name="rate" id="rate-5" values="5">
                            <label for="rate-5" class="fas fa-star"></label>
                            <input type="radio" name="rate" id="rate-4" values="4">
                            <label for="rate-4" class="fas fa-star"></label>
                            <input type="radio" name="rate" id="rate-3" values="3">
                            <label for="rate-3" class="fas fa-star"></label>
                            <input type="radio" name="rate" id="rate-2" values="2">
                            <label for="rate-2" class="fas fa-star"></label>
                            <input type="radio" name="rate" id="rate-1" values="1">

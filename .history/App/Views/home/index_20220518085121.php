                           ...
                           <a href="<?= DOCUMENT_ROOT . "/home/detail/" . $item['id'] . "/" . $item['mau'] ?>">
                               ...
                               <div class="item__price d-flex-end">
                                   <?php
                                    if($item['khuyen_mai']==1){
                                        ...
                                        echo '<span class="item__price-current">'.number_format($item["gia"]).'đ</span>';
                                    };
                                   ?>
                               ...
                               <div class="item__rating">
                                   ...
                                   <span class="item__rating-star">
                                       <?php for ($x = 1; $x <= floor($data[$item['id']]['avg']['tb']); $x++) { ?>
                                           <i class="fa fa-star text-warning"></i>
                                       <?php } ?>

                                       <?php for ($x = 1; $x <= 5 - floor($data[$item['id']]['avg']['tb']) - floor(5 - $data[$item['id']]['avg']['tb']); $x++) { ?>
                                           <i class="fas fa-star-half-alt text-warning"></i>
                                       <?php } ?>

                                       <?php for ($x = 1; $x <= floor(5 - $data[$item['id']]['avg']['tb']); $x++) { ?>
                                   ...
                                   </span> <?= ($data[$item['id']]['count_cmt']['soluong']) ?> đánh giá
                               </div>
                           </a>

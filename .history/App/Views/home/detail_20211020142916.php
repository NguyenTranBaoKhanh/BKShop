    ...
    <div class="wrapper">
        <div class="container ">
            ...
            <div class="product__name d-flex justify-content-between">
                <span class="name"><?= $data['item']['ten'] ?></span>
            ...
            <div class="d-flex productDetails">
                <div class="productDetail-left">
                    <img src="<?= PUBLIC_URL ?>/img/<?= $data['item']['hinh'] ?>" alt="" class="productDetails__img">
                </div>
                <div class="productDetail-center">
                    ...
                    <button onclick="addToCart(<?= isset($_SESSION['user']) ?  $_SESSION['user']['id'] : 0 ?>,<?= $item['id'] ?>)" class="btn-addtocart">Thêm vào giỏi hàng</button>
                </div>
                            ...
                            <a href="<?= DOCUMENT_ROOT . "/home/detail/" . $item['id'] . "/" . $item['mau'] ?>">
                                <div class="wipper__item">
                                    ...
                                    <div class="wipper__item__price d-flex-end">
                                        ...
                                        <span class="wipper__item__price-current"><?= $item['gia'] * 0.95 ?>đ</span>
                                    </div>

            ...
            <div class="user-content d-flex">
                <div class="sidebar-user">
                    ...
                    <ul>
                        ...
                        <li><a href="<?=DOCUMENT_ROOT?>/khachhang"><i class="fas fa-user <?= $GLOBALS["currentController"]=="khachhang"? "sidebar-active": ""?>"></i>Thông tin khách hàng</a></li>
                ...
                <div class="body-user">
                    <div class="form-user">
                        ...
                        <form action="<?=DOCUMENT_ROOT?>/khachhang/update/<?=$_SESSION['user']['id']?>" method="post">
                            <div class="">
